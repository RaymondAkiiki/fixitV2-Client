...
export const AuthProvider = ({ children }) => {
    ...
    const logout = useCallback(() => {
        ...
        // Optionally, clear Axios default headers if needed, though interceptor should handle it
    ...
    const authContextValue = {
        ...
        hasRole: useCallback((roleToCheck) => {
            return user && user.role?.toLowerCase() === roleToCheck.toLowerCase();
        }, [user]),
        hasAnyRole: useCallback((rolesArray) => {
            if (!user) return false;
            return rolesArray.some(role => user.role?.toLowerCase() === role.toLowerCase());
        }, [user]),
    };
