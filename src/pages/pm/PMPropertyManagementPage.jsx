// frontend/src/pages/pm/PMPropertyManagementPage.jsx
...
/**
 * PMPropertyManagementPage allows Property Managers/pms to list, add, edit, and delete properties.
 */
function PMPropertyManagementPage() {
                  ...
                  <tr key={prop._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-3">
                        <Link to={`/pm/properties/${prop._id}`} className="text-blue-600 hover:text-blue-900" title="View Details">
                          <Eye className="w-5 h-5" />
                        </Link>
                        <Link to={`/pm/properties/edit/${prop._id}`} className="text-indigo-600 hover:text-indigo-900" title="Edit Property">
...
export default PMPropertyManagementPage;