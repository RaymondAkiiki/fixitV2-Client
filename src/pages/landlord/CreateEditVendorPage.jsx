// frontend/src/pages/landlord/CreateEditVendorPage.jsx
...
import { addVendor, getVendorById, updateVendor } from "../../services/vendorService";
...
/**
 * CreateEditVendorPage allows Property Managers to add new vendors or
 * edit existing ones.
 */
function CreateEditVendorPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/landlord/vendors'); // Redirect to vendors list after success
    } catch (err) {
