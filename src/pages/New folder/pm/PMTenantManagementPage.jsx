...
import { getAllUsers, deleteUserById, createUser } from '../../services/userService'; // Use getAllUsers with role filter
...
function PMTenantManagementPage() {
    ...
    const handleDeleteTenant = async (tenantId) => {
        if (window.confirm("Are you sure you want to delete this tenant? This action cannot be undone and will remove all their associations.")) {
            try {
                // Backend deleteUserById handles cascading cleanup for PropertyUser entries etc.
    ...
    const handleCreateInvite = async () => {
        ...
        // This would call your new inviteService.createInvite function
