// frontend/src/pages/pm/PMPropertyDetailsPage.jsx
...
// Icons
import { Edit, Trash2, PlusCircle, Home, Maximize, Bed, Bath, User, Users, Square } from 'lucide-react';
...
/**
 * PMPropertyDetailsPage displays detailed information about a single property,
 * allows editing property details, and manages its associated units and tenants.
 */
function PMPropertyDetailsPage() {
    ...
    <div className="p-4 md:p-8 bg-gray-50 min-h-full">
            ...
            {property.units.map(unit => (
              <div key={unit._id} className="bg-gray-50 p-6 rounded-lg shadow-sm border border-gray-200 flex flex-col justify-between">
                ...
                <div className="mt-4 flex justify-end space-x-3">
                  <Link to={`/pm/properties/${propertyId}/tenants/${unit._id}`} className="text-sm text-blue-600 hover:underline flex items-center space-x-1" title="Manage Tenants for this Unit">
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 mb-10">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link to={`/pm/tenants?propertyId=${propertyId}`} className="text-blue-600 hover:underline font-medium flex items-center space-x-1">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {property.tenants.map(tenant => (
              <li key={tenant._id} className="bg-gray-50 p-4 rounded-lg shadow-sm border border-gray-200">
                ...
                <Link to={`/pm/properties/${propertyId}/tenants/${tenant._id}`} className="text-indigo-600 hover:underline text-sm mt-2 block">
                  View/Manage Tenant
                </Link>
              </li>
            ))}
...
export default PMPropertyDetailsPage;
