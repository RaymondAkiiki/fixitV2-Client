// frontend/src/pages/pm/PMCreateEditRequestPage.jsx
...
/**
 * PMCreateEditRequestPage allows Property Managers to create new requests or
 * comprehensively edit existing ones.
 */
function PMCreateEditRequestPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/pm/requests'); // Redirect to requests list after success
    } catch (err) {
...
export default PMCreateEditRequestPage;
